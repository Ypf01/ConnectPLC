...
{
	public class InovanceCFG
	{
		public static List<NodeInovance> LoadXmlFile(string xml)
		{
			List<NodeInovance> list = new List<NodeInovance>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 110.ToString())
							{
								NodeInovance nodeInovance = new NodeInovance
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									InovanceDeviceGroup inovanceDeviceGroup = new InovanceDeviceGroup
									{
										...
										StoreArea = (InovanceStoreArea)Enum.Parse(typeof(InovanceStoreArea), XMLCFG.XMLAttributeGetValue(xmlNode4, "StoreArea"), true),
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										InovanceVariable inovanceVariable = new InovanceVariable
										{
											...
											GroupID = (int)inovanceDeviceGroup.SlaveID,
										...
										inovanceVariable.Config = configEnitity;
										inovanceDeviceGroup.varList.Add(inovanceVariable);
									}
									nodeInovance.DeviceGroupList.Add(inovanceDeviceGroup);
								}
								list.Add(nodeInovance);
							}
						}
					}
				}
