...
{
	public class ModbusASCIIOverTCPCFG
	{
		public static List<NodeModbusASCIIOverTCP> LoadXmlFile(string xml)
		{
			List<NodeModbusASCIIOverTCP> list = new List<NodeModbusASCIIOverTCP>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 7000.ToString())
							{
								NodeModbusASCIIOverTCP nodeModbusASCIIOverTCP = new NodeModbusASCIIOverTCP
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									ModbusASCIIOverTCPGroup modbusASCIIOverTCPGroup = new ModbusASCIIOverTCPGroup
									{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusASCIIOverTCPVariable modbusASCIIOverTCPVariable = new ModbusASCIIOverTCPVariable
										{
											...
											KeyWay = nodeModbusASCIIOverTCP.KeyWay
										};
										...
										modbusASCIIOverTCPVariable.Config = configEnitity;
										modbusASCIIOverTCPGroup.varList.Add(modbusASCIIOverTCPVariable);
									}
									nodeModbusASCIIOverTCP.ModbusAsciiOverTCPGroupList.Add(modbusASCIIOverTCPGroup);
								}
								list.Add(nodeModbusASCIIOverTCP);
							}
						}
					}
				}
