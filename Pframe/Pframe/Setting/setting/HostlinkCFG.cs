...
{
	public class HostlinkCFG
	{
		public static List<NodeOmronHostlink> LoadXmlFile(string xml)
		{
			List<NodeOmronHostlink> list = new List<NodeOmronHostlink>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 60.ToString())
							{
								NodeOmronHostlink nodeOmronHostlink = new NodeOmronHostlink
								{
									...
									PLCUnit = int.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "PLCUnit")),
									PCUnit = int.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "PCUnit")),
									DeviceNum = int.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "DeviceNum")),
								...
								foreach (object obj3 in childNodes3)
								{
									...
									OmronHostlinkDeviceGroup omronHostlinkDeviceGroup = new OmronHostlinkDeviceGroup
									{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										OmronHostlinkVariable omronHostlinkVariable = new OmronHostlinkVariable
										{
											...
											KeyWay = nodeOmronHostlink.KeyWay
										};
										...
										omronHostlinkVariable.Config = configEnitity;
										omronHostlinkDeviceGroup.varList.Add(omronHostlinkVariable);
									}
									nodeOmronHostlink.DeviceGroupList.Add(omronHostlinkDeviceGroup);
								}
								list.Add(nodeOmronHostlink);
							}
						}
					}
				}
