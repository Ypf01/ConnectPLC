...
{
	public class SiemensPPICFG
	{
		public static List<NodeSiemensPPI> LoadXmlFile(string xml)
		{
			List<NodeSiemensPPI> list = new List<NodeSiemensPPI>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 90.ToString())
							{
								NodeSiemensPPI nodeSiemensPPI = new NodeSiemensPPI
								{
									...
									Station = byte.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "Station")),
								...
								foreach (object obj3 in childNodes3)
								{
									...
									SiemensPPIDeviceGroup siemensPPIDeviceGroup = new SiemensPPIDeviceGroup
									{
										...
										StoreArea = (SiemensPPIStoreArea)Enum.Parse(typeof(SiemensPPIStoreArea), XMLCFG.XMLAttributeGetValue(xmlNode4, "StoreArea"), true),
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										SiemensPPIVariable gclass = new SiemensPPIVariable
										{
										...
										siemensPPIDeviceGroup.varList.Add(gclass);
									}
									nodeSiemensPPI.DeviceGroupList.Add(siemensPPIDeviceGroup);
								}
								list.Add(nodeSiemensPPI);
							}
						}
					}
				}
