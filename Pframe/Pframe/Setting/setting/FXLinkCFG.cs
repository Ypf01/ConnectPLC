...
{
	public class FXLinkCFG
	{
		public static List<NodeFXLink> LoadXmlFile(string xml)
		{
			List<NodeFXLink> list = new List<NodeFXLink>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 80.ToString())
							{
								NodeFXLink nodeFXLink = new NodeFXLink
								{
									...
									StationNo = int.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "StationNo")),
									TimeOut = int.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "TimeOut")),
									SumCheckEnable = bool.Parse(XMLCFG.XMLAttributeGetValue(xmlNode3, "SumCheckEnable")),
								...
								foreach (object obj3 in childNodes3)
								{
									...
									FXLinkDeviceGroup fxlinkDeviceGroup = new FXLinkDeviceGroup
									{
										...
										StoreArea = (MelsecStoreArea)Enum.Parse(typeof(MelsecStoreArea), XMLCFG.XMLAttributeGetValue(xmlNode4, "StoreArea"), true),
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										FXLinkVariable fxlinkVariable = new FXLinkVariable
										{
										...
										fxlinkVariable.Config = configEnitity;
										fxlinkDeviceGroup.varList.Add(fxlinkVariable);
									}
									nodeFXLink.DeviceGroupList.Add(fxlinkDeviceGroup);
								}
								list.Add(nodeFXLink);
							}
						}
