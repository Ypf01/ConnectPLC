...
{
	public class ModbusRTUOverUDPCFG
    {
		public static List<NodeModbusRTUOverUDP> LoadXmlFile(string xml)
		{
			List<NodeModbusRTUOverUDP> list = new List<NodeModbusRTUOverUDP>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 6000.ToString())
							{
								NodeModbusRTUOverUDP gclass = new NodeModbusRTUOverUDP
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									ModbusRTUOverUDPGroup modbusRTUOverUDPGroup = new ModbusRTUOverUDPGroup
									{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusRTUOverUDPVariable modbusRTUOverUDPVariable = new ModbusRTUOverUDPVariable
										{
											...
											GroupID = modbusRTUOverUDPGroup.SlaveID,
										...
										modbusRTUOverUDPVariable.Config = configEnitity;
										modbusRTUOverUDPGroup.varList.Add(modbusRTUOverUDPVariable);
									}
									gclass.ModbusRTUOverUDPGroupList.Add(modbusRTUOverUDPGroup);
								}
								list.Add(gclass);
							}
						}
