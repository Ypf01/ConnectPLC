...
namespace NodeSettings
{
	...
	{
		public static List<NodeModbusTCP> LoadXmlFile(string xml)
		{
			List<NodeModbusTCP> list = new List<NodeModbusTCP>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 2000.ToString())
							{
								NodeModbusTCP nodeModbusTCP = new NodeModbusTCP
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									ModbusTCPGroup modbusTCPGroup = new ModbusTCPGroup
									{
										...
										SlaveID = (int)byte.Parse(XMLCFG.XMLAttributeGetValue(xmlNode4, "SlaveID")),
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusTCPVariable modbusTCPVariable = new ModbusTCPVariable
										{
											...
											GroupID = modbusTCPGroup.SlaveID,
										...
										modbusTCPVariable.Config = configEnitity;
										modbusTCPGroup.varList.Add(modbusTCPVariable);
									}
									nodeModbusTCP.ModbusTCPGroupList.Add(modbusTCPGroup);
								}
								list.Add(nodeModbusTCP);
							}
						}
					}
				}
