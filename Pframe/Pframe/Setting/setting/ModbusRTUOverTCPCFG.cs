...
{
	public class ModbusRTUOverTCPCFG
	{
		public static List<NodeModbusRTUOverTCP> LoadXmlFile(string xml)
		{
			List<NodeModbusRTUOverTCP> list = new List<NodeModbusRTUOverTCP>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 5000.ToString())
							{
								NodeModbusRTUOverTCP gclass = new NodeModbusRTUOverTCP
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusRTUOverTCPVariable modbusRTUOverTCPVariable = new ModbusRTUOverTCPVariable
										{
											...
											GroupID = modbusRTUOverTCPGroup.SlaveID,
										...
										modbusRTUOverTCPVariable.Config = configEnitity;
										modbusRTUOverTCPGroup.varList.Add(modbusRTUOverTCPVariable);
									}
									gclass.ModbusRtuOverTCPGroupList.Add(modbusRTUOverTCPGroup);
								}
								list.Add(gclass);
							}
						}
