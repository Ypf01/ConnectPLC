...
namespace NodeSettings
{
	...
	{
		public static List<NodeModbusRTU> LoadXmlFile(string xml)
		{
			List<NodeModbusRTU> list = new List<NodeModbusRTU>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 1000.ToString())
							{
								NodeModbusRTU nodeModbusRTU = new NodeModbusRTU
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusRTUVariable modbusRTUVariable = new ModbusRTUVariable
										{
											...
											GroupID = modbusRTUGroup.SlaveID,
										...
										modbusRTUVariable.Config = configEnitity;
										modbusRTUGroup.varList.Add(modbusRTUVariable);
									}
									nodeModbusRTU.ModbusRTUGroupList.Add(modbusRTUGroup);
								}
								list.Add(nodeModbusRTU);
							}
						}
					}
				}
