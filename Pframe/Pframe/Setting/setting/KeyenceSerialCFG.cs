...
{
	public class KeyenceSerialCFG
	{
		public static List<NodeKeyenceSerial> LoadXmlFile(string xml)
		{
			List<NodeKeyenceSerial> list = new List<NodeKeyenceSerial>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 150.ToString())
							{
								NodeKeyenceSerial nodeKeyenceSerial = new NodeKeyenceSerial
								{
								...
								foreach (object obj3 in childNodes3)
								{
									...
									KeyenceSerialDeviceGroup keyenceSerialDeviceGroup = new KeyenceSerialDeviceGroup
									{
										...
										StoreArea = (KeyenceStoreArea)Enum.Parse(typeof(KeyenceStoreArea), XMLCFG.XMLAttributeGetValue(xmlNode4, "StoreArea"), true),
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										KeyenceSerialVariable keyenceSerialVariable = new KeyenceSerialVariable
										{
											...
											KeyWay = nodeKeyenceSerial.KeyWay
										};
										...
										keyenceSerialVariable.Config = configEnitity;
										keyenceSerialDeviceGroup.varList.Add(keyenceSerialVariable);
									}
									nodeKeyenceSerial.DeviceGroupList.Add(keyenceSerialDeviceGroup);
								}
								list.Add(nodeKeyenceSerial);
							}
						}
					}
				}
