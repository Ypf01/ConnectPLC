...
{
	public class ModbusASCIIOverUDPCFG
	{
		public static List<NodeModbusASCIIOverUDP> LoadXmlFile(string xml)
		{
			List<NodeModbusASCIIOverUDP> list = new List<NodeModbusASCIIOverUDP>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "ModbusNode")
						{
							...
							if (a == 8000.ToString())
							{
								NodeModbusASCIIOverUDP nodeModbusASCIIOverUDP = new NodeModbusASCIIOverUDP
								{
									Name = XMLCFG.XMLAttributeGetValue(xmlNode3, "Name"),
									Description = XMLCFG.XMLAttributeGetValue(xmlNode3, "Description"),
									String_0 = XMLCFG.XMLAttributeGetValue(xmlNode3, "ServerURL"),
								...
								foreach (object obj3 in childNodes3)
								{
									...
									ModbusASCIIOverUDPGroup modbusASCIIOverUDPGroup = new ModbusASCIIOverUDPGroup
									{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										ModbusASCIIOverUDPVariable modbusASCIIOverUDPVariable = new ModbusASCIIOverUDPVariable
										{
											...
											KeyWay = nodeModbusASCIIOverUDP.KeyWay
										};
										...
										modbusASCIIOverUDPVariable.Config = configEnitity;
										modbusASCIIOverUDPGroup.varList.Add(modbusASCIIOverUDPVariable);
									}
									nodeModbusASCIIOverUDP.ModbusAsciiOverUDPGroupList.Add(modbusASCIIOverUDPGroup);
								}
								list.Add(nodeModbusASCIIOverUDP);
							}
						}
					}
				}
