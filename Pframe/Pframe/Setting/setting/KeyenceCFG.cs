...
{
	public class KeyenceCFG
	{
		public static List<NodeKeyence> LoadXmlFile(string xml)
		{
			List<NodeKeyence> list = new List<NodeKeyence>();
			try
			{
				...
				foreach (object obj in childNodes)
				{
					...
					foreach (object obj2 in childNodes2)
					{
						...
						if (xmlNode3.Name == "DeviceNode")
						{
							...
							if (a == 20.ToString())
							{
								NodeKeyence nodeKeyence = new NodeKeyence
								{
									...
									PlcType = (KeyenceProtocol)Enum.Parse(typeof(KeyenceProtocol), XMLCFG.XMLAttributeGetValue(xmlNode3, "PlcType"), true),
								...
								foreach (object obj3 in childNodes3)
								{
									...
									KeyenceDeviceGroup keyenceDeviceGroup = new KeyenceDeviceGroup
									{
									...
									foreach (object obj4 in xmlNode4)
									{
										...
										KeyenceVariable keyenceVariable = new KeyenceVariable
										{
										...
										keyenceVariable.Config = configEnitity;
										keyenceDeviceGroup.varList.Add(keyenceVariable);
									}
									nodeKeyence.DeviceGroupList.Add(keyenceDeviceGroup);
								}
								list.Add(nodeKeyence);
							}
						}
					}
				}
