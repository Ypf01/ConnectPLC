...
{
	public class DeltaEthernetDeviceGroup : NodeClass, IXmlConvert
	{
		public DeltaEthernetDeviceGroup()
		{
			this.varList = new List<DeltaEthernetVariable>();
			base.Name = "组对象";
		...
		public override void LoadByXmlElement(XElement element)
		{
			...
			this.SlaveID = int.Parse(element.Attribute("SlaveID").Value);
		...
		public List<DeltaEthernetVariable> varList;
