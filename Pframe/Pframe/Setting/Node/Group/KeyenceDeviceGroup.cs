...
{
	public class KeyenceDeviceGroup : NodeClass, IXmlConvert
	{
		public KeyenceDeviceGroup()
		{
			this.varList = new List<KeyenceVariable>();
			base.Name = "组对象";
		...
		public List<KeyenceVariable> varList;
