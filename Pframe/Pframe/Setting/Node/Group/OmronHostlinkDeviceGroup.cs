...
{
	public class OmronHostlinkDeviceGroup : NodeClass, IXmlConvert
	{
		public OmronHostlinkDeviceGroup()
		{
			this.varList = new List<OmronHostlinkVariable>();
			base.Name = "组对象";
			base.Description = "作为一次批量的字节数据读取";
			this.Length = 10;
			this.StoreArea = OmronStoreArea.D存储区;
			this.Start = "D0";
			base.NodeType = 100;
			base.NodeHead = "DeviceGroup";
			this.Type = "OmronHostlink";
			this.IsActive = true;
		}
        
		public OmronStoreArea StoreArea { get; set; }
		...
		public override void LoadByXmlElement(XElement element)
		{
			...
			this.StoreArea = (OmronStoreArea)Enum.Parse(typeof(OmronStoreArea), element.Attribute("StoreArea").Value, true);
		...
		public List<OmronHostlinkVariable> varList;
