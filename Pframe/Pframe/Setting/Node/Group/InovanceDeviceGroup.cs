...
{
	public class InovanceDeviceGroup : NodeClass, IXmlConvert
	{
		public InovanceDeviceGroup()
		{
			this.varList = new List<InovanceVariable>();
			base.Name = "组对象";
			base.Description = "作为一次批量的字节数据读取";
			this.Length = 10;
			this.StoreArea = InovanceStoreArea.D存储区;
			this.Start = "D0";
			this.SlaveID = 1;
			base.NodeType = 100;
		...
		public InovanceStoreArea StoreArea { get; set; }
		...
		public override void LoadByXmlElement(XElement element)
		{
			...
			this.StoreArea = (InovanceStoreArea)Enum.Parse(typeof(InovanceStoreArea), element.Attribute("StoreArea").Value, true);
		...
		public List<InovanceVariable> varList;
