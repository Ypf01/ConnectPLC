...
{
	public class ModbusRTUOverTCPGroup : NodeClass, IXmlConvert
	{
		public ModbusRTUOverTCPGroup()
		{
			this.varList = new List<ModbusRTUOverTCPVariable>();
			base.Name = "组对象";
		...
		public List<ModbusRTUOverTCPVariable> varList;
	}
}
