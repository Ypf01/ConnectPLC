...
{
	public class ModbusASCIIOverUDPGroup : NodeClass, IXmlConvert
	{
		public ModbusASCIIOverUDPGroup()
		{
			this.varList = new List<ModbusASCIIOverUDPVariable>();
			base.Name = "组对象";
		...
		public List<ModbusASCIIOverUDPVariable> varList;
	}
}
