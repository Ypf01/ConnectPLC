...
{
	public class ModbusASCIIGroup : NodeClass, IXmlConvert
	{
		public ModbusASCIIGroup()
		{
			this.varList = new List<ModbusASCIIVariable>();
			base.Name = "组对象";
		...
		public List<ModbusASCIIVariable> varList;
	}
}
