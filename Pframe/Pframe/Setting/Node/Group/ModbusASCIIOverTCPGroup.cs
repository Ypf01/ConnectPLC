...
{
	public class ModbusASCIIOverTCPGroup : NodeClass, IXmlConvert
	{
		public ModbusASCIIOverTCPGroup()
		{
			this.varList = new List<ModbusASCIIOverTCPVariable>();
			base.Name = "组对象";
		...
		public List<ModbusASCIIOverTCPVariable> varList;
	}
}
