...
{
	public class XinjeXCDeviceGroup : NodeClass, IXmlConvert
	{
		public XinjeXCDeviceGroup()
		{
			this.varList = new List<XinjeXCVariable>();
			base.Name = "组对象";
			base.Description = "作为一次批量的字节数据读取";
			this.Length = 10;
			this.StoreArea = XinjeXCStoreArea.D存储区;
			this.Start = "D0";
			this.SlaveID = 1;
			base.NodeType = 100;
		...
		public XinjeXCStoreArea StoreArea { get; set; }
		...
		public override void LoadByXmlElement(XElement element)
		{
			...
			this.StoreArea = (XinjeXCStoreArea)Enum.Parse(typeof(XinjeXCStoreArea), element.Attribute("StoreArea").Value, true);
		...
		public List<XinjeXCVariable> varList;
