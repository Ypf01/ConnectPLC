...
namespace Pframe
{
	public class ModbusASCIIMsg : IMessage
	{
		public ModbusASCIIMsg(ModbusMessage message = null)
		{
		...
		public int GetContentLength()
		{
			if (this.Message != null)
			{
				...
				case FunctionCode.ReadInputStatus:
					return 11 + IntLib.GetIntFromBoolLength((int)this.Message.NumberOfPoints);
				case FunctionCode.ReadKeepReg:
				case FunctionCode.ReadInputReg:
					return (int)(11 + this.Message.NumberOfPoints * 2);
