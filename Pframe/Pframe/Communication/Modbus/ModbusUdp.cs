...
{
	public class ModbusUdp : ModbusTcpMessage
	{
		...
		public ModbusUdp(string ipAddress, int port, DataFormat dataFormat = DataFormat.ABCD)
		{
		...
		public override byte[] ReadOutputStatus(byte slaveAddress, ushort startAddress, ushort numberOfPoints)
		{
			...
			byte[] response = null;
			if (this.AOQHBZKECN(byte_, ref response, new ModbusTCPMsg(modbusMessage), 5000))
			{
		...
		private bool AOQHBZKECN(byte[] byte_1, ref byte[] byte_2, IMessage imessage_0 = null, int int_7 = 5000)
		{
